...
// استيراد الخدمات من مجلد services
import * as treeService from './services/treeService';
import * as memberService from './services/memberService';

// استيراد المكونات بناءً على هيكل المجلدات في الصورة
import NavBar from './components/NavBar/NavBar'; // تأكدي من وجود الملف داخل مجلد NavBar
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/trees/:id" element={
          <TreeDetail findTreeToUpdate={findTreeToUpdate} deleteTrees={deleteTrees} />
        } />
        <Route path="/trees/:id/update" element={
          <TreeForm treeToUpdate={treeToUpdate} updateOneTree={updateOneTree} />
        } />

        {/* مسارات الأعضاء */}
        <Route path="/members" element={<MemberList members={members} />} />
        <Route path="/members/new" element={
          <MemberForm updateMembers={addMember} trees={trees} members={members} />
        } />
        <Route path="/members/:id" element={
          <MemberDetail findMemberToUpdate={findMemberToUpdate} deleteMember={deleteMember} />
        } />
        <Route path="/members/:id/update" element={
          <MemberForm memberToUpdate={memberToUpdate} updateOneMember={updateOneMember} trees={trees} members={members} />
        } />
      </Routes>
    </>
  );
